...
PROJ_PATH=.
DATA_PATH=$PROJ_PATH/data/cifar10/val/airplane/
...
python3 -m torch.distributed.launch --nproc_per_node=1 extract_embeddings.py --data_path $DATA_PATH --dump_features $OUT_PATH/embeddings/epoch0300 --pretrained_weights $CKPT_PATH --checkpoint_key teacher --batch_size_per_gpu 64 --arch swin_tiny --cfg experiments/imagenet/swin/swin_tiny_patch4_window7_224.yaml MODEL.NUM_CLASSES 0
